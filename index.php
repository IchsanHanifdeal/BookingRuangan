          ...
          <div class="col px-0">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-6 text-center">
                <h1 style="color:#FFF">Selamat Datang di Booking Ruangan!</h1>
                <p class="lead text-white">Jadikan pengalaman booking ruangan menjadi lebih mudah dan efisien.</p>
              </div>
            </div>
          </div>
        </div>
